...
const io = new Server(server, {
    cors: {
        origin: ["https://trigunrobotics.com/smarthealth/"],
...
server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`Drone interface: https://trigunrobotics.com/smarthealth/drone.html`);
    console.log(`Doctor interface: https://trigunrobotics.com/smarthealth/doctor.html`);
    console.log(`Main interface: https://trigunrobotics.com/smarthealth/`);
});
